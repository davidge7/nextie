...
export default function AboutPage() {
  ...
  if (!hydrated) return null; // or a loading placeholder
    ...
    ">
      ...
      `}>
        ...
        <p className={`text-base sm:text-lg md:text-xl lg:text-2xl ${themeClasses.textSecondary} mb-6 md:mb-8 leading-relaxed`}>
          Nextie is building the future of AI-assisted development tools. It empowers developers to write code faster, smarter, and more efficiently with cutting-edge technology.
        </p>

        <div className="flex flex-col space-y-4 text-left text-sm sm:text-base md:text-lg">
          <p className={themeClasses.textMuted}>
            Founded in 2025, The mission is to simplify software development and accelerate innovation.
          </p>
          <p className={themeClasses.textMuted}>
            We leverage AI, modern frameworks, and responsive design to deliver exceptional developer experiences.
          </p>
        </div>
      </div>
    </main>
